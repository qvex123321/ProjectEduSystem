...
//			System.out.println(id.getClass().getName()); //id = String
			// 讀取瀏覽器傳送來的type，以分辨要處理哪個表格
			MemberService memberService = new MemberServiceImpl();
			MembersBean bean = memberService.queryMember(id);
			if (bean != null) {
			...
			ex.printStackTrace();
			throw new RuntimeException("RetrieveMemberImageServlet#doGet()發生SQLException: " + ex.getMessage());
		} finally {
			if (is != null)
				is.close();
			if (os != null)
