    ...
    ([
        ...
        (function(module, exports, __webpack_require__) {
            ...
            var EventManager = /** @class */ (function() {
                ...
                // matchInput can either by a real event source object, an ID, or the function/id for the source.
        ...
        (function(module, exports, __webpack_require__) {
            ...
            var JsonFeedEventSource = /** @class */ (function(_super) {
                ...
                JsonFeedEventSource.parse = function(rawInput, calendar) {
                    var rawProps;
                    // normalize raw input
                    if (typeof rawInput.id === 'string') { // extended form
                        rawProps = rawInput;
                    } else if (typeof rawInput === 'string') { // short form
                        rawProps = { id: rawInput };
                    }
                    if (rawProps) {
                        return EventSource_1.default.parse.call(this, rawProps, calendar);
                    }
            ...
            var TimeGridEventRenderer = /** @class */ (function(_super) {
                ...
                TimeGridEventRenderer.prototype.fgSegHtml = function(seg, disableResizing) {
                    ...
                    return '<a class="' + classes.join(' ') + '"' +
                        (eventDef.id ?
                            ' id="' + util_1.htmlEscape(eventDef.id) + '"' :
                            '') +
                        (skinCss ?
                            ' style="' + skinCss + '"' :
                            '') +
                    ...
                    for (i = 0; i < levelCnt; i++) { // iterate through all levels
                        ...
                        if (levelSegs) {
                            for (j = 0; j < levelSegs.length; j++) { // iterate through segments in level
                                ...
                                td = $('<td class="fc-event-container" onClick="check(this.children[0].id)"/>').append(seg.el);
            ...
            var ListEventRenderer = /** @class */ (function(_super) {
                ...
                ListEventRenderer.prototype.fgSegHtml = function(seg) {
                    ...
                    return '<tr class="' + classes.join(' ') + '">' +
                        ...
                        '<a' + (id ? ' id="' + util_1.htmlEscape(eventDef.id) + '"' : '') + '>' +
                        util_1.htmlEscape(eventDef.title || '') +
                        '</a>' +
                        '</td>' +
                        '</tr>';
        ...
        (function(module, exports, __webpack_require__) {
            ...
            var ListEventPointing = /** @class */ (function(_super) {
                ...
                // for events with a id, the whole <tr> should be clickable,
                // but it's impossible to wrap with an <a> tag. simulate this.
                ListEventPointing.prototype.handleClick = function(seg, ev) {
                    var id;
                    _super.prototype.handleClick.call(this, seg, ev); // might prevent the default action
                    // not clicking on or within an <a> with an id
                    if (!$(ev.target).closest('a[id]').length) {
                        id = seg.footprint.eventDef.id;
                        if (id && !ev.isDefaultPrevented()) { // jsEvent not cancelled in handler
                            window.location.id = id; // simulate link click
                        }
                    }
                };
                                ...
                                if (buttonName === 'title') {
                                    ...
                                    if (buttonClick) {
                                        ...
                                        if (buttonText) {
                                            ...
                                            buttonAriaAttr = ' id="' + buttonName + '" onClick="dpButton(this.id)"';
                                        }
